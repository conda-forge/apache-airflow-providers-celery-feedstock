About apache-airflow-providers-celery-feedstock
===============================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/apache-airflow-providers-celery-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/apache-airflow-providers-celery-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add apache-airflow-providers-celery
# for installing globally
pixi global install apache-airflow-providers-celery
```
...
It is possible to list all of the versions of `apache-airflow-providers-celery` available on your platform:
...
```
pixi search apache-airflow-providers-celery --channel conda-forge
```
