About apache-airflow-providers-celery
=====================================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/apache-airflow-providers-celery-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11944&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/apache-airflow-providers-celery-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `apache-airflow-providers-celery` can be installed with:

```
conda install apache-airflow-providers-celery
```

It is possible to list all of the versions of `apache-airflow-providers-celery` available on your platform with:
